...
export default function ProfileCard({ user }) {
    ...
    const formattedDate = userCreatedDate.toLocaleDateString('en-US', {
        month: 'long',
        year: 'numeric'
    });

    const dateString = formattedDate.replace(/ (\d{4})$/, ', $1');
        ...
        <>
            <div>
                <div className="w-full bg-cover bg-no-repeat bg-center"
                    style={{ height: '200px', backgrounImage: 'url(https://pbs.twimg.com/profile_banners/2161323234/1585151401/600x200)' }}>
                    <img
                ...
                <div className="p-4">
                            ...
                            <div style={{ marginTop: '-6rem' }}>
                                <div style={{ height: '9rem', width: '9rem' }} className="md rounded-full relative avatar">
                                    <img
                                        ...
                                        className="bg-blue-400 md rounded-full relative border-4 border-gray-900"
                                        src={user.avatar}
                                        alt="" />
                    ...
                    <div className="space-y-1 justify-center w-full pt-3 pl-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm leading-5 font-medium text-gray-500">{user.tag}</p>
                        </div>
