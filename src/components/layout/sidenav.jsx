            ...
            <div className="h-screen px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 flex flex-col items-center">
                ...
                <ul className="space-y-4 pt-10">
                    <li className="py-3">
                        <button
                            onClick={() => navigate("/")}
                            className="hover:cursor-pointer w-full flex items-center px-4 py-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                        >
