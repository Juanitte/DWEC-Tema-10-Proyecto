            ...
            <article className="hover:bg-green-800 transition duration-350 ease-in-out">
              ...
              <div>
                ...
                <div className="flex items-center justify-around py-4">
                  ...
                  {/* ➤ Compartidos */}
                  <div className="flex-1 flex items-center justify-center text-white text-xs text-gray-400 hover:text-green-400 transition duration-350 ease-in-out">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 mr-2">
                      <g>
                        <path
                  ...
                  {/* ➤ Icono “enlace” o “compartir” */}
                  <div className="flex-1 flex items-center justify-center text-white text-xs text-gray-400 hover:text-orange-400 transition duration-350 ease-in-out">
